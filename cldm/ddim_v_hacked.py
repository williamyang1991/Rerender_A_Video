...
class DDIMVSampler(object):
    ...
    def sample(self,
        ...
        samples, intermediates = self.ddim_sampling(conditioning, size,
                                                    ...
                                                    mask=mask, x0=x0, xtrg=xtrg, noise_rescale=noise_rescale,
    ...
    def ddim_sampling(self, cond, shape,
                      ...
                      mask=None, x0=None, xtrg=None, noise_rescale=None, img_callback=None, log_every_t=100,
                      temperature=1., noise_dropout=0., score_corrector=None, corrector_kwargs=None,
                      unconditional_guidance_scale=1., unconditional_conditioning=None, dynamic_threshold=None,
                      ucg_schedule=None, controller=None, strength=0.0):
        ...
        for i, step in enumerate(iterator):
            ...
            if mask is not None and xtrg is not None:
                ...
                if weight is not None:
                    rescale = torch.maximum(1.-weight, (1-weight**2)**0.5 * 0.9)
            ...
            outs = self.p_sample_ddim(img, cond, ts, index=index, use_original_steps=ddim_use_original_steps,
                                      ...
                                      unconditional_guidance_scale=unconditional_guidance_scale,
                                         unconditional_conditioning=unconditional_conditioning,
                                      dynamic_threshold=dynamic_threshold, controller=controller, return_dir=True)#, mask=mask[i], xtrg=xtrg)
    ...
    def p_sample_ddim(self, x, c, t, index, repeat_noise=False, use_original_steps=False, quantize_denoised=False,
                      ...
                      dynamic_threshold=None, controller=None, return_dir=False):#, mask=None, xtrg=None):
