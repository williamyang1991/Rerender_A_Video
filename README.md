...
2. `FileNotFoundError: [Errno 2] No such file or directory: 'xxxx.bin' or 'xxxx.jpg'`:
    ...
    - if some frames are generated but somes are not, rather than missing all frames, you may refer to https://github.com/williamyang1991/Rerender_A_Video/issues/38#issuecomment-1730668991
